                ...
                <Form onSubmit={onHotspotSubmit} >
                    <Modal.Body>
                        ...
                        <Form.Group className="mb-3">
                            ...
                            >
                                {
                                    typeof interfaces === 'object' && interfaces !== null ? Object.keys(interfaces).map((iface, i) => (
                        ...
                        <Form.Group className="mb-3">
                            ...
                            >
                                {
                                    typeof pools === 'object' && pools !== null ? Object.keys(pools).map((pool, i) => (
                        ...
                        <Form.Group className="mb-3">
                            ...
                            >
                                {
                                    typeof hotspot_profiles === 'object' && hotspot_profiles !== null ? Object.keys(hotspot_profiles).map((prof, i) => (
